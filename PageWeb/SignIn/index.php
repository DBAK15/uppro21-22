  ...
  <main class="form-signin p-2">
    ...
    <form action="connect.php" method="POST">
      ...
      <div class="form-floating">
        <input name="username" type="text" class="form-control" id="floatingInput" placeholder="sykodinc">
      ...
      Pas encore inscrit faite le <a href="../signup/index.php" style="color: white">Ici</a>
