  ...
  <div class="container-fluid">
    ...
    <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="./Switch.php">Changer de compte</a>
        </li>
...
<main class="container">
  ...
  <form method="post" action="../signin/connect.php">
    <img class="mb-4" src="sykodIMG.png" alt="" width="102" height="74">
    <h1 class="h3 mb-3 fw-normal">Veuillez vous identifiez</h1>

    <div class="form-floating">
      <input type="text" name = "username" class="form-control" id="floatingInput" placeholder="sykodinc">
