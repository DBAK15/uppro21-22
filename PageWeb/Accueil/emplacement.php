...
<main class="container">
  ...
  <?php 
    require("../../ESPDATA/select_locdata_true.php"); 
    if($_GET['latitude']){
        $row_Latitude = $_GET['latitude'];
        $row_Longitude = $_GET['longitude'];
        echo "<iframe src=\"https://maps.google.com/maps?&q=$row_Latitude,$row_Longitude;&output=embed \" width=\"100%\" height=\"400\"></iframe>";
    }
    else{
        echo "<iframe src=\"https://maps.google.com/maps?&q=$row_Latitude,$row_Longitude&output=embed \" width=\"100%\" height=\"400\"></iframe>";
    }
  ?>
  <!--<iframe src="https://maps.google.com/maps?&q=<?php //echo $row_Latitude.','.$row_Longitude  ?>&output=embed " width="100%" height="400"></iframe>-->
